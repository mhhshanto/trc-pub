        ...
        <div className='lg:mt-[110px] mt-16'>
            <div className='bg-[url("https://taylorandfrancis.com/wp-content/uploads/2021/04/bg-world-4.jpg")] bg-cover bg-no-repeat '>
                <div className='bg-[#00000082]'>
                    <h1 className='py-20 text-3xl md:container px-3 text-white'>Email us to place a pre-order for any of our books.</h1>
            ...
            <div className='flex min-h-[40vh] justify-center items-center md:flex-row gap-5 sm:container mx-auto px-3 my-8'>
