        ...
        <div className='mt-10 container mb-16 mx-auto 2xl:px-60 xl:px-40 lg:px-16 px-5'>

            {
                data.map((item, index) => <div className='mb-20' key={index}>
                    <div data-aos={`${index === 1 ? 'fade-right' : 'fade-left'}`} data-aos-duration="1000" className={` flex md:flex-row flex-col md:gap-y-0 gap-y-5   ${index === 1 && 'md:flex-row-reverse'} justify-between`}>
                        ...
                        <div data-aos={`${index === 1 ? 'fade-right' : 'fade-left' }`} data-aos-duration="1000" className={`md:w-[50%] w-full  ${index == 0 ? 'bg-[#ffbe00]' : index == 1 ? 'bg-[#007a96]' : 'bg-[#f2673c]'} p-3`}>
